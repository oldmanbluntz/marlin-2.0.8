...
#define STRING_CONFIG_H_AUTHOR "The Mike Bailey" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Mike Maker"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 81.27, 80.16, 409.42, 93 }
...
#define Z_SERVO_ANGLES { 55, 155 } // Z Servo Deploy and Stow angles
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 2, -35, -6.41 }
...
#define XY_PROBE_FEEDRATE (240*60)
...
#define Z_HOMING_HEIGHT  2      // (mm) Minimal Z height before homing (G28) for Z clearance abov]e the bed, clamps, ...
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  //#define FIL_RUNOUT_PIN     27         // Use different pin for filament runout.
